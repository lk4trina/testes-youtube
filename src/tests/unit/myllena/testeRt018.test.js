...
describe('ComentarioController', () => {
    ...
    it('deve adicionar um comentário válido', () => {
      ...
      const resultado = controller.adicionarComentario(userID, videoID, comentario);
    ...
    it('deve retornar erro para comentário com menos de 2 caracteres', () => {
      ...
      expect(() => controller.adicionarComentario(userID, videoID, comentario)).toThrow(
        'O comentário deve ter no mínimo 2 caracteres.'
      );
